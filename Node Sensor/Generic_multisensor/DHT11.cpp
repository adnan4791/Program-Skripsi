...
#define DHT11_DATA_BIT_COUNT 41
...
DHT11::DHT11(uint8_t pin)
{
    ...
    _lastHumidity = DHT11_ERROR_VALUE;
    _lastTemperature = DHT11_ERROR_VALUE;
}
...
//
DHT11_ERROR_t DHT11::readData()
{
  uint8_t bitmask = _bitmask;
  volatile uint8_t *reg asm("r30") = _baseReg;
  uint8_t retryCount;
  uint8_t bitTimes[DHT11_DATA_BIT_COUNT];
  int currentHumidity;
